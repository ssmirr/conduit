module github.com/Psiphon-Inc/conduit/cli
...
replace github.com/pion/ice/v2 => ./psiphon-tunnel-core/replace/ice

replace github.com/pion/webrtc/v3 => ./psiphon-tunnel-core/replace/webrtc
