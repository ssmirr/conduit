...
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please submit a pull request with a file under the `/contributors` directory indicating your acceptance of this agreement, following the instructions at [CONTRIBUTING.md](./CONTRIBUTING.md).
...
(d) You have followed the instructions in [CONTRIBUTING](./CONTRIBUTING.md), if You do not own the Copyright in the entire work of authorship Submitted.
